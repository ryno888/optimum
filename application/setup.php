...
defined('CI_BASE_URL')          OR define('CI_BASE_URL', "http://localhost/optimum/"); 
defined('CI_NAME')              OR define('CI_NAME', "Optimum Refridgeration"); 
defined('CI_ENCRYPT_KEY')       OR define('CI_ENCRYPT_KEY', "OptimumKey"); 

//site db
defined('DB_DATABASE')          OR define('DB_DATABASE', false); 
defined('DB_HOST_NAME')         OR define('DB_HOST_NAME', false); 
defined('DB_USERNAME')          OR define('DB_USERNAME', false); 
defined('DB_PASSWORD')          OR define('DB_PASSWORD', false); 
defined('DB_PORT')              OR define('DB_PORT', false); 
